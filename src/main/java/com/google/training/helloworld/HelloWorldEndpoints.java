...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name = "greetWithMessage", path = "greetWithMessage",
            httpMethod = HttpMethod.GET)
    
    public HelloClass greetWithMessage(@Named("name")String name, @Named("period")String timeOfDay, @Named("gender") String gender){
    	return new HelloClass(name, timeOfDay, gender);
    }
}
